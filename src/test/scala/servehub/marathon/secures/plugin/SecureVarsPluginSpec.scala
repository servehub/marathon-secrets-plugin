...
class SecureVarsPluginSpec extends FreeSpec with MustMatchers {
  ...
  "initialization with a configuration" in {
    val plugin = new SecureVarsPlugin()
    ...
    plugin.varPrefix mustBe "SECURE_"
    plugin.env mustBe "prod"
  }
  ...
  "decrypt values" in {
    ...
    val result = SecureVarsPlugin.decrypt(privateKey, "")
  ...
  "applying the plugin" in {
    ...
    when(plugin.httpClient.asString).thenReturn(HttpResponse[String]("""
      {
        "secrets": {
          "some.test.value": {
            "value": {
              "dev": "open-password",
              "prod": "ENC:"
            },
            "target": [
    ...
    builder.getCommand.getEnvironment.getVariablesList.toList.map(v ⇒ v.getName → v.getValue).toMap mustBe Map(
      "SECURE_SOME_TEST_VALUE" → "kulikov-test",
      "SECURE_SECONDS_PLAIN_VALUE" → "pass123"
    )
  }
}
